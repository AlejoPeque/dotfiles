...
[ -s "$HOMEBREW_PREFIX/opt/nvm/etc/bash_completion.d/nvm" ] && \. "$HOMEBREW_PREFIX/opt/nvm/etc/bash_completion.d/nvm" # This loads nvm bash_completionH

## Scripts
# neofetch
# pokemon-colorscripts -r
cowsay "Hello Ale, what are we doing today?"
